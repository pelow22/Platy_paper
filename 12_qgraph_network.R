...
rede <- qgraph(matriz, directed=TRUE, bidirectional = FALSE, usePCH=TRUE, threshold = 0.1,
               labels = etiqueta, nodeNames = nomes, vsize = tamanhos,
               shape = "circle", vTrans = 255, label.prop = 0.7, borders = TRUE,
               edge.color = "gray20", fade = FALSE, curveAll = TRUE, curve = 0.5,
...
#groups = grupos, palette = "pastel",edge.color = "royalblue3",
